...
import * as service from "../utility/service" // Importing service functions
...
import * as localUser from "../utility/localUser" // Importing local user utility
export function Create() {
    ...
    async function handleCreate(event) {
        ...
        const expirationTime = Date.now() + 1 * 60 * 1000 // Auction expiration time
